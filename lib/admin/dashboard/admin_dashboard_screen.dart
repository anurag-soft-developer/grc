...
class AdminDashboardScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fromKey = activeRange != null
        ...
        : null;
    final toKey = activeRange != null
        ? formatDashboardApiDate(activeRange.end)
        : null;
                      ...
                      itemBuilder: (context, index) {
                        final cards = [
                          ...
                          DashboardStatCard(
                            ...
                            subtitle:
                                '${analytics.revenue.paidRegistrations} paid',
...
class _DateRangeSelect extends StatelessWidget {
  ...
  const _DateRangeSelect({required this.selected, required this.onChanged});
